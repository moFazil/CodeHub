...
import '../../Style/CssnotesStyle/intro.css';
...
export const Htmlintro = () => {
  return (
    <div className='intro'>
        ...
        <h3><span>&lt;h1&gt;</span> My First Heading <span>&lt;/h1&gt;</span> </h3>
        <h5><span>&lt;p&gt; My first paragraph. &lt;/p&gt;</span></h5>

        <p className="note"> Note: Some HTML elements have no content (like the <span> &lt;br&gt; </span> element). These elements are called empty elements. Empty elements do not have an end tag! </p>
        ...
        <img src={require('../../image/heading.png')} alt="web browser" />
