...
export const Htmltables = () => {
  return (
    <div className='table'>
        ...
        <img src={require('../../image/tables.png')} alt="Tables" />
        ...
        <img src={require('../../image/tablecell.png')} alt="Table cell" />
        ...
        <img src={require('../../image/tablerow.png')} alt="Table row" />
        ...
        <img src={require('../../image/tablehead.png')} alt="Table head" />
