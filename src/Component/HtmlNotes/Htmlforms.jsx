  ...
  return (
    <div className='forms'>
     <h1> HTML Forms </h1>
            ...
            <h2> The <span>&lt;label&gt;</span>  Element </h2>
            ...
            <img src={require('../../image/radiobtn.png')} alt="radio button" />
        ...
        <img src={require('../../image/checkbox.png')} alt="checkbox" />
        ...
        <img src={require('../../image/submitbtn.png')} alt="submit button" />
